################################################################################
# Plot runtime results for parameter estimation for an unbalanced random effects design.
################################################################################
...
Gaussian_results <- readRDS("./time_vs_m_unbalanced_Gaussian.rds")
Bernoulli_results <- readRDS("./time_vs_m_unbalanced_Bernoulli.rds")
